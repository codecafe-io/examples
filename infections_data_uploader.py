...
def loadInfectionsData(tableName=INFECTIONS_TABLE_NAME, bucketRegion=BUCKET_REGION,  
...
if __name__ == '__main__':
    print("Add infections data from the sample CSV file to Infections table:")
    loadInfectionsData()